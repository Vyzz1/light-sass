...
export function ShineBorder({
  ...
  return (
    <div
      ...
      className={cn(
        "relative min-h-[60px] w-fit bg-transparent min-w-[300px] place-items-center rounded-[--border-radius]  text-black dark:bg-black dark:text-white overflow-clip p-1 ",
        className
      )}
    >
      <div
